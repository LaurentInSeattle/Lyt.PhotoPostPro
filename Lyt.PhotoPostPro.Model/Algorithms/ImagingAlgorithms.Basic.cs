...
{
	public static void ApplyColorTemperature(this Image<RgbaVector> image, float temperature)
	{
	...
	public static bool ApplyGlobalContrast(
		this Image<RgbaVector> image, float contrastAmount, float blurAmount, float brightnessAmount )
	{
	...
	public static bool ApplyGlobalSaturation(this Image<RgbaVector> image, float saturationAmount)
	{
	...
	public static bool ApplyGlobalSharpen(this Image<RgbaVector> image, float sharpenAmount)
	{
