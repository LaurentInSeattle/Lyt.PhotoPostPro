...
public partial class CullingImageView : View
{
    ...
    {
        if ((sender is CullingImageView view) && (this == view))
        {
            this.isInside = true;
            this.SetVisualState();
        }
    ...
    private void OnPointerReleased(object? sender, PointerEventArgs args)
    {
        ...
        if ((sender is CullingImageView view) && (this == view))
        {
            if (wasInside && this.DataContext is CullingImageViewModel thumbnailViewModel)
            {
                this.isInside = false;
                this.isSelected = true;
                this.SetVisualState();
