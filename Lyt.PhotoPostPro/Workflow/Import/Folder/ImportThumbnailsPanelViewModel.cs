...
public sealed partial class ImportThumbnailsPanelViewModel :
    ViewModel<ImportThumbnailsPanelView>,
    ISelectListener,
    IRecipient<LanguageChangedMessage>
{
    ...
    [ObservableProperty]
    public partial ObservableCollection<ImportThumbnailViewModel> Thumbnails { get; set; }
