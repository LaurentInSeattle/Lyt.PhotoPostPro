...
public partial class ImportThumbnailView : View
{
    ...
    public ImportThumbnailView() : base () 
    {
    ...
    {
        if ((sender is ImportThumbnailView view) && (this == view))
        {
            this.isInside = true;
            this.SetVisualState();
        }
    ...
    private void OnPointerReleased(object? sender, PointerEventArgs args)
    {
        ...
        if ((sender is ImportThumbnailView view) && (this == view))
        {
            if (wasInside && this.DataContext is ImportThumbnailViewModel thumbnailViewModel)
            {
                this.isInside = false;
                this.isSelected = true;
                this.SetVisualState();
