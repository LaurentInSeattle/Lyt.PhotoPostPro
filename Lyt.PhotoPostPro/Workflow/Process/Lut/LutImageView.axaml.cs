...
public partial class LutImageView : View
{
    ...
    {
        if ((sender is LutImageView view) && (this == view))
        {
            this.isInside = true;
            this.SetVisualState();
        }
    ...
    private void OnPointerReleased(object? sender, PointerEventArgs args)
    {
        ...
        if ((sender is LutImageView view) && (this == view))
        {
            if (wasInside && this.DataContext is LutImageViewModel thumbnailViewModel)
            {
                this.isInside = false;
                this.isSelected = true;
                this.SetVisualState();
