...
public partial class ValleyCG : UserControl
{
    ...
    {
        if (sender is ValleyCG diagonal)
        {
    ...
    public static readonly StyledProperty<SolidColorBrush> BrushProperty =
        AvaloniaProperty.Register<ValleyCG, SolidColorBrush>(
            nameof(Brush),
