...
public partial class HSelectorControl : UserControl
{
    public static readonly StyledProperty<List<SelectorButtonViewModel>> SelectorButtonsProperty =
            AvaloniaProperty.Register<HSelectorControl, List<SelectorButtonViewModel>>(
    ...
    {
        if (sender is HSelectorControl hSelectorControl)
        {
            hSelectorControl.SelectorItemsControl.ItemsSource = value;
